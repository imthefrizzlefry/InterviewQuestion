...
describe("Function to check whether strings A and B can be combined to make string C", function(){

  describe("When A and B can combined to make C", function(){
  ...
  describe("When A and B cannot be combined to make C", function(){
